...
const CaseDocumentsCreateDialogComponent = (props) => {
    ...
    const setId = (id) => { setValByKey("uploadedDocument", id);  };
...
<div className="col-12 field">
                <span className="align-items-center">
                    ...
                    <UploadFilesToS3 type={'create'} user={props.user} id={urlParams.id} serviceName="caseDocuments" onUploadComplete={setId} onFileLoaded={onFileLoaded}/>
                </span>
                <small className="p-error">
