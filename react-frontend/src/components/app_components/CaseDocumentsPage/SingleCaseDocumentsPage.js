...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">File Type</label><p className="m-0 ml-3" >{_entity?.fileType}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Storage Path</label><p className="m-0 ml-3" >{_entity?.storagePath}</p></div>
