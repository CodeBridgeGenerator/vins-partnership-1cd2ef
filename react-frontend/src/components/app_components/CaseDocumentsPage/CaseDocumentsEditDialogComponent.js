...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="uploadTimestamp" value={_entity?.uploadTimestamp ? new Date(_entity?.uploadTimestamp) : null} onChange={ (e) => setValByKey("uploadTimestamp", new Date(e.target.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
