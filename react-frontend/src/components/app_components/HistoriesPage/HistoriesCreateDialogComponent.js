...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="timestamp"  value={_entity?.timestamp ? new Date(_entity?.timestamp) : null} dateFormat="dd/mm/yy" onChange={ (e) => setValByKey("timestamp", new Date(e.target.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
