...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <Calendar id="collisionDateTime" value={_entity?.collisionDateTime ? new Date(_entity?.collisionDateTime) : null} onChange={ (e) => setValByKey("collisionDateTime", new Date(e.target.value))} showIcon showButtonBar  />
            </span>
            <small className="p-error">
